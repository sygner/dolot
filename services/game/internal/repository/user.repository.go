...
func (c *gameRepository) GetGameById(gameId string) (*models.Game, *types.Error) {
	query := `SELECT id, name, game_type, num_main_numbers, num_bonus_numbers, main_number_range, bonus_number_range, start_time, end_time, creator_id, result, created_at 
